<template>
    <app-layout title="Editar usuarios">
        <template #header>
                    ...
                    <form class="flex flex-col items-center p-16" @submit.prevent="guardar">
                        ...
                        <div class="flex items-center justify-between mt-4 w-96">
                            ...
                            <div class="ml-4">
                                ...
                                font-bold
                                rounded-xl
                              " v-if="!usuarios.deleted_at" type="button" @click="eliminar">
...
export default {
    ...
    setup(props) {
        const form = useForm({ ...props.usuarios });
        const guardar = () => {
            form.put(route("usuarios.update", props.usuarios.id));
        };
        const eliminar = () => {
            Swal.fire({
                title: "¿Esta seguro?",
                ...
                if (res.isConfirmed) {
                    form.delete(route("usuarios.destroy", props.usuarios.id));
                }
            });
        };
