                ...
                <div class="bg-gray-50 shadow-2xl p-8">
                    <form class="flex flex-col items-center p-16" @submit.prevent="guardar"
                        ...
                        <div class="text-center mt-5 mb-10 border-2 border-neutral-900 p-2 rounded-xl w-52">
                            <jet-label for="campo1" :value="recursos.nombre_documento" />
                        </div>

                        <div class="flex items-center justify-between mt-4 w-96">
                            <Link
                                :href="route('estudiantes.show', recursos.id_estudiante)"
                            ...
                            <div class="ml-4">
                                <button class="
                                  ...
                                  font-bold
                                  rounded-xl
                                " v-if="!recursos.deleted_at" type="button" @click="eliminar">
...
export default {
    ...
    props: {
        ...
        recursos: { type: Object, required: true },
    ...
    setup(props) {
        const form = useForm({ ...props.recursos });
        ...
        const eliminar = () => {
            Swal.fire({
                ...
                if (res.isConfirmed) {
                    form.delete(route("recursos.destroy", props.recursos.id));
                }
            });
        };
